...
export const SCAN_MESSAGES = {
  ...
  PLAN_LIMIT: { en: 'Your account already has the maximum number of stores.' },
  TRIAL_LIMIT: { en: 'The free trial allows 2 stores. Activate a plan on a store to add more.' },
